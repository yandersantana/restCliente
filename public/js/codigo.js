...
function enviarCuento(user, callback) {
    ...
    $.ajax({
        url: 'https://fathomless-cove-24634.herokuapp.com/guardarCuento',
        type: 'POST',
        data: cuentero,
        cache: false,
    ...
    $.ajax({
        url: 'https://fathomless-cove-24634.herokuapp.com/idCuento',
        type: 'GET',
        cache: false,
        success: function (idCuento) { //obtenemos el ultimo id del cuento guardado
            ...
            for (imagen of user.cuento.imagenes) {
                ...
                $.ajax({ //vamos guardando las imagenes del cuento
                    url: 'https://fathomless-cove-24634.herokuapp.com/guardarImagenes',
                    type: 'POST',
                    data: imagenesCuento,
                    cache: false,
                    success: function (data) {
            ...
            if (user.cuento.audios != undefined) {
                for (audio of user.cuento.audios) {
                    ...
                    $.ajax({ //vamos guardando los Audios del cuento
                        url: 'https://fathomless-cove-24634.herokuapp.com/guardarAudios',
                        type: 'POST',
                        data: audiosCuento,
                        cache: false,
                        success: function (data) {
                ...
                for (pregunta of user.cuento.preguntas) { //recorremos cada pregunta
                    if (pregunta != undefined && pregunta.pregunta != "") {
                        ...
                        $.ajax({ //vamos guardando la pregunta 
                            url: 'https://fathomless-cove-24634.herokuapp.com/guardarPregunta',
                            type: 'POST',
                            data: ask,
                            cache: false,
                        ...
                        $.ajax({
                            url: 'https://fathomless-cove-24634.herokuapp.com/idPregunta',
                            type: 'GET',
                            cache: false,
                            success: function (idPregunta) { //obtenemos el ultimo id de la pregunta guardada
                                ...
                                for (imagen of preguntaCopiada.imagens) {
                                    ...
                                    $.ajax({ //vamos guardando las imagenes de las preguntas 
                                        url: 'https://fathomless-cove-24634.herokuapp.com/guardarPreguntaImagenes',
                                        type: 'POST',
...
function enviarUsuario(user, callback) {
    ...
    $.ajax({
        url: 'https://fathomless-cove-24634.herokuapp.com/guardarUsuario',
        type: 'POST',
        data: usuario,
        cache: false,
        success: function (data) {},
...
function existeUsuario(user, callback) {
    $.ajax({
        url: 'https://fathomless-cove-24634.herokuapp.com/existeUsuario',
        type: 'GET',
        cache: false,
        success: function (data) {
            callback(data);
...
$(document).ready(function () {
    ...
    $('.AgregarImg').click(function () {
        ...
        $.ajax({
            url: 'https://fathomless-cove-24634.herokuapp.com/subir',
            type: 'POST',
            // Form data
            //datos del formulario
            data: formData,
...
function cargarUsuario() {
    ...
    $.ajax({
        url: 'https://fathomless-cove-24634.herokuapp.com/cargarUsuarioPorId/'+user,
        type: 'GET',
        data: elem,
        cache: false,
...
function editarCuento() {
    ...
    $(this).slideUp(300).delay(2000).fadeIn(400);
    $.ajax({
        url: 'https://fathomless-cove-24634.herokuapp.com/cargarCuentoPorId/'+idcue,
        type: 'GET',
        data: elem,
        cache: false,
    ...
    $.ajax({
        url: 'https://fathomless-cove-24634.herokuapp.com/listarImagenes/'+idcue,
        type: 'GET',
        data: elem,
        cache: false,
...
*/
            ...
            $.ajax({
                url: 'https://fathomless-cove-24634.herokuapp.com/listarAudios/'+idcue,
                type: 'GET',
                data: elem,
                cache: false,
            ...
            $.ajax({ //vamos extrayendo la pregunta 
                url: 'https://fathomless-cove-24634.herokuapp.com/listarPreguntas/'+idcue,
                type: 'GET',
                data: elem,
                cache: false,
...
function listarImagenesPreguntas(idpre, callback) {
    ...
    $.ajax({
        url: 'https://fathomless-cove-24634.herokuapp.com/listarImagenesPreguntas/'+idpreg,
        type: 'POST',
        data: pregunt,
        cache: false,
...
function peticionUsuarios(callback) {
    var datos = "";
    $.ajax({
        url: 'https://fathomless-cove-24634.herokuapp.com/usuarios',
        type: 'GET',
